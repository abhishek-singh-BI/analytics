...
excel_file = "../202303_Task1_Sessions.xlsx"
...
traffic_type_stats = (
    ...
    .agg({"session_duration": "mean", "clickouts": "mean", "bookings": "mean"})
    .reset_index()
)
...
df["conversion_rate"] = df.apply(
    lambda row: row["bookings"] / row["clickouts"] if row["clickouts"] > 0 else 0,
    axis=1,
)
...
summary_stats.to_excel("../summary_statistics.xlsx", sheet_name="Summary")
traffic_type_stats.to_excel(
    "../traffic_type_statistics.xlsx",
    sheet_name="Traffic_Type",
)
country_sessions.to_excel("../country_sessions.xlsx", sheet_name="Country")
platform_sessions.to_excel("../platform_sessions.xlsx", sheet_name="Platform")
repeat_sessions.to_excel("../repeat_sessions.xlsx", sheet_name="Repeat")
conversion_rate_stats.to_excel(
    "../conversion_rate_statistics.xlsx",
    sheet_name="Conversion_Rate",
)
